...
Player id's will be created as hands are input into the console by inputting 3 cards (example- Ah 3d Tc) and then pressing enter until all players have hands, then the winning player id is output into the console. 
